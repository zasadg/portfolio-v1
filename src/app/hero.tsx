...
export default function Hero() {
    return (
        <section className="min-h-screen relative max-w-5xl lg:px-32 px-16 py-16 flex flex-col justify-center items-left text-white">
            <motion.div
                className=""
            ...
            >
                <section className="">
                    ...
                    <p className="mt-4 text-lg leading-relaxed">
                        While being a designer, empathizing with ux outcome is not just my goal but aiming for balance between business goals and development feasibility is already baked into my mental model.
                    </p>
