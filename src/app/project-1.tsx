...
export default function Hero() {
    ...
    return (
        <>
            <section className="relative min-h-screen w-full px-16 py-16 flex flex-col justify-center items-left">
            ...
            {isExpanded && (
                <section className="maxw-full px-16 py-16 relative bg-gray-50" id="project-details">
                    <div className="">
