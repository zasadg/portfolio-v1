        ...
        <>
            ...
            {isExpanded && (
                <section className="details max-w-full lg:px-40 px-16 py-16 relative" id="project-details">
                    <div className="">
                        <div className="mb-8">
                            <h2 className="text-3xl font-bold mb-6 text-[#4B51BF]">Data analytics experiences</h2>
                    ...
                    <div className="pt-24">
                       ...
                       <div className="pt-24">
                        <div className="mb-8">
                            <h2 className="text-3xl font-bold mb-6 text-[#4B51BF]">Customer landing page</h2>
                            <p className="project-description">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                <img 
                                    src="/projects_images/details-1-7.png" 
                            ...
                            <div className="space-y-4">
                                <img 
                                    src="/projects_images/details-1-8.png" 
